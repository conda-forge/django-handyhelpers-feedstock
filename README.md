About django-handyhelpers-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-handyhelpers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-handyhelpers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-handyhelpers
# for installing globally
pixi global install django-handyhelpers
```
...
It is possible to list all of the versions of `django-handyhelpers` available on your platform:
...
```
pixi search django-handyhelpers --channel conda-forge
```
